...
optimus_p = Optimus_p(model, micro_batch_size, use_gpu=True, pp_size=2, tp_size=1, dp_size=2, activation_ckpt=True, force_free_mem=True, display_mem=True, swap_opt_in_fwdbwd=False, swap_model_in_optstep=False, ir_analyze=IR_Anal.SEQUENTIAL)
